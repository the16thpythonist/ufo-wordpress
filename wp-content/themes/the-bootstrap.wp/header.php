			...
			<div id="page" class="hfeed row">
				...
				<header id="branding" role="banner" class="span12">
					...
					<hgroup>
                        <div id="head">
                            <div id="head-left">
                            <div id="logo"><a href="http://www.kit.edu" title="KIT-Logo - Link zur KIT-Startseite"><img src="<?php bloginfo('url'); ?>/wp-content/themes/the-bootstrap/kit_logo.svg" alt="KIT-Logo - Link zur KIT-Startseite" width="100%" height="100%"></a></div></div>
                            <div id="head-right">
